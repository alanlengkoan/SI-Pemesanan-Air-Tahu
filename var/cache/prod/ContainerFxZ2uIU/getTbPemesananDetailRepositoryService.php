 ...
 */
class getTbPemesananDetailRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\TbPemesananDetailRepository' shared autowired service.
     *
     * @return \App\Repository\TbPemesananDetailRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbPemesananDetailRepository.php';

        return $container->privates['App\\Repository\\TbPemesananDetailRepository'] = new \App\Repository\TbPemesananDetailRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService')));
    }
}
