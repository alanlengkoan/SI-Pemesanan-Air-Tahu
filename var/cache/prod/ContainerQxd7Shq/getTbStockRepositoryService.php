 ...
 */
class getTbStockRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbStockRepository' shared autowired service.
     *
     * @return \App\Repository\TbStockRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbStockRepository.php';

        return $container->privates['App\\Repository\\TbStockRepository'] = new \App\Repository\TbStockRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
