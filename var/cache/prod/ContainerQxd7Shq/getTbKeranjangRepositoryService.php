 ...
 */
class getTbKeranjangRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbKeranjangRepository' shared autowired service.
     *
     * @return \App\Repository\TbKeranjangRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbKeranjangRepository.php';

        return $container->privates['App\\Repository\\TbKeranjangRepository'] = new \App\Repository\TbKeranjangRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
