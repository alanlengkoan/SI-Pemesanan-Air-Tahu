 ...
 */
class getSecurity_Authentication_Provider_Dao_AdminSecuredAreaService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'security.authentication.provider.dao.admin_secured_area' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authentication.provider.dao.admin_secured_area'] = new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(($container->privates['security.user.provider.concrete.admin'] ?? $container->load('getSecurity_User_Provider_Concrete_AdminService')), ($container->privates['security.user_checker'] ?? ($container->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())), 'admin_secured_area', ($container->privates['security.encoder_factory.generic'] ?? $container->load('getSecurity_EncoderFactory_GenericService')), true);
    }
}
