...
class getSecurity_Firewall_Map_Context_UserSecuredAreaService extends App_KernelProdDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 5), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($container->privates['security.authentication.trust_resolver'] ?? ($container->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), $b, 'user_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint(($container->services['http_kernel'] ?? $container->getHttpKernelService()), $b, 'login_user', false), '/home', NULL, ($container->privates['logger'] ?? ($container->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), false), new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, $c, ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'app_logout']), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('user_secured_area', 'security.user_checker', '.security.request_matcher.01Y6ZVJ', true, false, 'security.user.provider.concrete.user', 'user_secured_area', 'security.authentication.form_entry_point.user_secured_area', NULL, NULL, [0 => 'form_login', 1 => 'anonymous'], NULL));
    }
}
