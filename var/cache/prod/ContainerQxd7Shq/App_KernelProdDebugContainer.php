...
class App_KernelProdDebugContainer extends Container
{
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['security.authentication.provider.dao.user_secured_area'] ?? $this->load('getSecurity_Authentication_Provider_Dao_UserSecuredAreaService'));
            yield 3 => ($this->privates['security.authentication.provider.anonymous.user_secured_area'] ?? ($this->privates['security.authentication.provider.anonymous.user_secured_area'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
        }, 4), true);
