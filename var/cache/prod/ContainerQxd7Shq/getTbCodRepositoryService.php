 ...
 */
class getTbCodRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbCodRepository' shared autowired service.
     *
     * @return \App\Repository\TbCodRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbCodRepository.php';

        return $container->privates['App\\Repository\\TbCodRepository'] = new \App\Repository\TbCodRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
