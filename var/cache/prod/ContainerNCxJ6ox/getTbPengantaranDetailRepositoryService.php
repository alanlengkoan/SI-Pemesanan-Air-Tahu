 ...
 */
class getTbPengantaranDetailRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\TbPengantaranDetailRepository' shared autowired service.
     *
     * @return \App\Repository\TbPengantaranDetailRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbPengantaranDetailRepository.php';

        return $container->privates['App\\Repository\\TbPengantaranDetailRepository'] = new \App\Repository\TbPengantaranDetailRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService')));
    }
}
