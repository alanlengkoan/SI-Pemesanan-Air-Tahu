 ...
 */
class getTbKurirRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\TbKurirRepository' shared autowired service.
     *
     * @return \App\Repository\TbKurirRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbKurirRepository.php';

        return $container->privates['App\\Repository\\TbKurirRepository'] = new \App\Repository\TbKurirRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService')));
    }
}
