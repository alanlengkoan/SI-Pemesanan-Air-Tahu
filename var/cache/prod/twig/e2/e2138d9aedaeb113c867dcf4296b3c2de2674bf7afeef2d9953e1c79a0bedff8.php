...
class __TwigTemplate_568c48bd70d80e907eb3f88bc7f892c3694ab17c22156dc4390ecab2fd96a6a6 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["pelanggan"]) || array_key_exists("pelanggan", $context) ? $context["pelanggan"] : (function () { throw new RuntimeError('Variable "pelanggan" does not exist.', 42, $this->source); })()));
        $context['loop'] = [
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["rows"]) {
            ...
            echo "</td>
                                    <td>";
            // line 54
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["rows"], "kelamin", [], "any", false, false, false, 54), "L"))) ? ("Laki - laki") : ("Perempuan"));
            echo "</td>
                                    <td>";
            // line 55
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["rows"], "telepon", [], "any", false, false, false, 55), "html", null, true);
            echo "</td>
                                    <td>";
            // line 56
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["rows"], "alamat", [], "any", false, false, false, 56), "html", null, true);
            echo "</td>
                                </tr>
                                ";
            ++$context['loop']['index0'];
...
";
    ...
    {
        return array (  227 => 73,  222 => 72,  215 => 71,  207 => 67,  198 => 59,  181 => 56,  177 => 55,  173 => 54,  169 => 53,  162 => 49,  156 => 46,  151 => 44,  148 => 43,  131 => 42,  110 => 23,  107 => 21,  104 => 19,  97 => 14,  92 => 11,  85 => 9,  75 => 6,  68 => 5,  55 => 3,  38 => 1,);
    }
                        ...
                        <table id=\"tabel_pelanggan\" class=\"table table-striped table-bordered display no-wrap\" style=\"width:100%\">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ rows.nama }}</td>
                                    <td>{{ (rows.kelamin == \"L\" ? \"Laki - laki\" : \"Perempuan\") }}</td>
                                    <td>{{ rows.telepon }}</td>
                                    <td>{{ rows.alamat }}</td>
                                </tr>
                                {% endfor %}
