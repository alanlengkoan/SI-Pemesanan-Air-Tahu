 ...
 */
class getTbPengantaranRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbPengantaranRepository' shared autowired service.
     *
     * @return \App\Repository\TbPengantaranRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbPengantaranRepository.php';

        return $container->privates['App\\Repository\\TbPengantaranRepository'] = new \App\Repository\TbPengantaranRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
