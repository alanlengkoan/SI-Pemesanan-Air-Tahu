...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\KurirController' => 'getKurirControllerService',
            'App\\Controller\\Admin\\LaporanController' => 'getLaporanControllerService',
            'App\\Controller\\Admin\\PelangganController' => 'getPelangganControllerService',
            'App\\Controller\\Admin\\PembelianController' => 'getPembelianControllerService',
            'App\\Controller\\Admin\\PemesananController' => 'getPemesananControllerService',
            'App\\Controller\\Admin\\ProdukController' => 'getProdukControllerService',
            'App\\Controller\\Admin\\ProfilController' => 'getProfilControllerService',
            'App\\Controller\\Admin\\TambahstockController' => 'getTambahstockControllerService',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\KeranjangController' => 'getKeranjangControllerService',
            'App\\Controller\\Kurir\\DashboardController' => 'getDashboardController2Service',
            'App\\Controller\\Kurir\\PemesananController' => 'getPemesananController2Service',
            'App\\Controller\\Kurir\\ProfilController' => 'getProfilController2Service',
            'App\\Controller\\ProdukController' => 'getProdukController2Service',
            'App\\Controller\\ProfilController' => 'getProfilController3Service',
            'App\\Controller\\RegisterController' => 'getRegisterControllerService',
            'App\\Controller\\RiwayatController' => 'getRiwayatControllerService',
            'App\\Controller\\SecurityController' => 'getSecurityControllerService',
            'App\\Service\\MyfunctionHelper' => 'getMyfunctionHelperService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('aTzndJgm5h', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2UWXXGM3sn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P2pBKHY9Nj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E9IGdMPXQe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Yg6ksmQH91', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WPIjfVXnZ3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.dao.admin_secured_area'] ?? $this->load('getSecurity_Authentication_Provider_Dao_AdminSecuredAreaService'));
            yield 1 => ($this->privates['security.authentication.provider.anonymous.admin_secured_area'] ?? ($this->privates['security.authentication.provider.anonymous.admin_secured_area'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            yield 2 => ($this->privates['security.authentication.provider.dao.kurir_secured_area'] ?? $this->load('getSecurity_Authentication_Provider_Dao_KurirSecuredAreaService'));
            yield 3 => ($this->privates['security.authentication.provider.anonymous.kurir_secured_area'] ?? ($this->privates['security.authentication.provider.anonymous.kurir_secured_area'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            yield 4 => ($this->privates['security.authentication.provider.dao.user_secured_area'] ?? $this->load('getSecurity_Authentication_Provider_Dao_UserSecuredAreaService'));
            yield 5 => ($this->privates['security.authentication.provider.anonymous.user_secured_area'] ?? ($this->privates['security.authentication.provider.anonymous.user_secured_area'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
        }, 6), true);
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'security.firewall.map.context.admin_secured_area' => ['privates', 'security.firewall.map.context.admin_secured_area', 'getSecurity_Firewall_Map_Context_AdminSecuredAreaService', true],
            'security.firewall.map.context.dev' => ['privates', 'security.firewall.map.context.dev', 'getSecurity_Firewall_Map_Context_DevService', true],
            'security.firewall.map.context.kurir_secured_area' => ['privates', 'security.firewall.map.context.kurir_secured_area', 'getSecurity_Firewall_Map_Context_KurirSecuredAreaService', true],
            ...
            'security.firewall.map.context.kurir_secured_area' => '?',
            'security.firewall.map.context.user_secured_area' => '?',
        ]), new RewindableGenerator(function () {
            yield 'security.firewall.map.context.dev' => ($this->privates['.security.request_matcher.Iy.T22O'] ?? ($this->privates['.security.request_matcher.Iy.T22O'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/')));
            yield 'security.firewall.map.context.admin_secured_area' => ($this->privates['.security.request_matcher.UZgEAwa'] ?? ($this->privates['.security.request_matcher.UZgEAwa'] = new \Symfony\Component\HttpFoundation\RequestMatcher('/admin')));
            yield 'security.firewall.map.context.kurir_secured_area' => ($this->privates['.security.request_matcher.BB9u4g1'] ?? ($this->privates['.security.request_matcher.BB9u4g1'] = new \Symfony\Component\HttpFoundation\RequestMatcher('/kurir')));
            yield 'security.firewall.map.context.user_secured_area' => ($this->privates['.security.request_matcher.01Y6ZVJ'] ?? ($this->privates['.security.request_matcher.01Y6ZVJ'] = new \Symfony\Component\HttpFoundation\RequestMatcher('/')));
        }, 4));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('admin_secured_area', 'app_logout', 'logout', '_csrf_token', NULL, NULL);
        $instance->registerListener('kurir_secured_area', 'app_logout', 'logout', '_csrf_token', NULL, NULL);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'folder_produk' => (\dirname(__DIR__, 4).'/public_html/uploads/produk'),
            'folder_bukti' => (\dirname(__DIR__, 4).'/public_html/uploads/bukti'),
            'folder_profil' => (\dirname(__DIR__, 4).'/public_html/uploads/profil'),
            ...
            'security.firewalls' => [
                0 => 'dev',
                1 => 'admin_secured_area',
                2 => 'kurir_secured_area',
                3 => 'user_secured_area',
            ],
